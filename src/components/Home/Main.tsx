  ...
  return (
    <main className="flex justify-center items-center h-dvh mt-[-8rem]">
      <div className="max-w-[1080px] p-6">
        ...
        <p className="text-gray-400 py-4">Highly driven and performance focused Software Engineer with over 10 years of hands-on experience designing and developing responsive web applications.</p>
      </div>
